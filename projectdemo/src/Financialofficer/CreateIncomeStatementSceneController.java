 ...
 * @author Mahdi Hasan
 */
public class CreateIncomeStatementSceneController implements Initializable {

    @FXML
    private TextField createIncomeStatementAmountTF;
    @FXML
    ...
    @FXML
    private TextField createIncomeStatementRevenueTF;
    @FXML
    ...
    @FXML
    private void createIncomeStatementAddButtonOnClick(ActionEvent event) {
    }
