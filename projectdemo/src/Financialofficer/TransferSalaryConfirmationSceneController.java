 ...
 * @author Mahdi Hasan
 */
public class TransferSalaryConfirmationSceneController implements Initializable {
    ...
    @FXML
    private Button transferSalaryConfirmYesButton;
    @FXML
    private Button transferSalaryConfirmNoButton;
    ...
    @FXML
    private void transferSalaryConfirmYesButtonOnClick(ActionEvent event) {
    }

    @FXML
    private void transferSalaryConfirmNoButtonOnClick(ActionEvent event) {
    }
