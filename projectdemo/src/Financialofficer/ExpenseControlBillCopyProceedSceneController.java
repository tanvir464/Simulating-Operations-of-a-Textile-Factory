 ...
 * @author Mahdi Hasan
 */
public class ExpenseControlBillCopyProceedSceneController implements Initializable {
    ...
    @FXML
    private Button billCopyProceedYesButton;
    @FXML
    private Button billCopyProceedNoButton;
    ...
    @FXML
    private void billCopyProceedYesButtonOnClick(ActionEvent event) {
    }

    @FXML
    private void billCopyProceedNoButtonOnClick(ActionEvent event) {
    }
