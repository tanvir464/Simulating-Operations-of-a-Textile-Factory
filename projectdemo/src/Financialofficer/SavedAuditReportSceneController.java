 ...
 * @author Mahdi Hasan
 */
public class SavedAuditReportSceneController implements Initializable {
    ...
    @FXML
    private Button sendAuditReportToHRButton;
    ...
    @FXML
    private void sendAuditReportToHRButtonOnClick(ActionEvent event) {
    }
