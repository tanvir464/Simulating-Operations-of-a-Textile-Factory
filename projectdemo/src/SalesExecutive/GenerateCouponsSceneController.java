 ...
 * @author Mahdi Hasan
 */
public class GenerateCouponsSceneController implements Initializable {
    ...
    @FXML
    private ComboBox<?> selectOfferPercentageCB;
    @FXML
    private Button generateCouponCodeButton;
    @FXML
    private Label showCouponCodeLabel;
    @FXML
    private Button generateCouponCodeInPDFButton;
    ...
    @FXML
    private void generateCouponCodeButtonOnClick(ActionEvent event) {
    }

    @FXML
    private void generateCouponCodeInPDFButtonOnClick(ActionEvent event) {
    }
