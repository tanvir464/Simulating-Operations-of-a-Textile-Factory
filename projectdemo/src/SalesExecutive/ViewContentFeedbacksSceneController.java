 ...
 * @author Mahdi Hasan
 */
public class ViewContentFeedbacksSceneController implements Initializable {
    ...
    @FXML
    private TableView<?> contentFeedbacksTV;
    @FXML
    private TableColumn<?, ?> contentFeedbacksTableDateTC;
    @FXML
    private TableColumn<?, ?> contentFeedbacksTableFeedbackTC;
    @FXML
    private Button contentFeedbacksDownloadButton;
    ...
    @FXML
    private void selectProductCBOnClick(ActionEvent event) {
    }

    @FXML
    private void contentFeedbacksDownloadButtonOnClick(ActionEvent event) {
    }
