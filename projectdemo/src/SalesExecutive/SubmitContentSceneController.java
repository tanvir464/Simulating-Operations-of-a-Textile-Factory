 ...
 * @author Mahdi Hasan
 */
public class SubmitContentSceneController implements Initializable {
    ...
    @FXML
    private Button uploadContentPdfButton;
    @FXML
    private Button saveAndSubmitContentButton;
    ...
    @FXML
    private void uploadContentPdfButtonOnClick(ActionEvent event) {
    }

    @FXML
    private void saveAndSubmitContentButtonOnClick(ActionEvent event) {
    }
