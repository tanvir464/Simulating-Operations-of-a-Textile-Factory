 ...
 * @author Mahdi Hasan
 */
public class SalesCommunicationSceneController implements Initializable {
    ...
    @FXML
    private ComboBox<?> selectAffiliateCB;
    @FXML
    private TextField writeContentsForAffiliatesTF;
    @FXML
    private Button sendContentPlansToAffiliatesButton;
    @FXML
    private Label successfullySendContentPlansToAffiliatesLabel;
    ...
    @FXML
    private void sendContentPlansToAffiliatesButtonOnClick(ActionEvent event) {
    }
