 ...
 * @author Mahdi Hasan
 */
public class AdvertisementSceneController implements Initializable {
    ...
    @FXML
    private TableView<?> advertisementsTable;
    @FXML
    private TableColumn<?, ?> advertisementsTableProductTC;
    @FXML
    private TableColumn<?, ?> advertisementsTableADnoTC;
    @FXML
    private TableColumn<?, ?> advertisementsTableStartDateTC;
    @FXML
    private TableColumn<?, ?> advertisementsTableEndDateTC;
    @FXML
    private TableColumn<?, ?> advertisementsTableDetailsTC;
